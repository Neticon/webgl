...
THREE.DragControls = function ( _objects, _camera, _domElement, _dropObjects ) {
	...
	var _selected = null, _hovered = null, _activated = true;
	...
	function onDocumentMouseMove( event ) {
		...
		if ( intersects.length > 0 ) {
			...
			_plane.setFromNormalAndCoplanarPoint( new THREE.Vector3(0,0,1), object.position );
