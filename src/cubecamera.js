...
// cubeCamera.renderTarget.texture.minFilter = THREE.LinearMipMapNearestFilter
...
const cubeMat = new THREE.MeshPhongMaterial({ color: 0xababab, vertexColors: THREE.vertexColors })
const cube = new THREE.Mesh(cubeGeo, cubeMat)
cube.castShadow = true
cube.receiveShadow = true
const cubeGrid = object3DGrid(cube, 3, 1)
cubeGrid.children.map(cube=>{
