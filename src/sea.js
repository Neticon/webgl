...
const planeMesh = getPlane(30, 30, 60, 60)
planeMesh.name = "plane"
planeMesh.rotation.x = radiants(90)
planeMesh.rotation.z = radiants(45)
planeMesh.castShadow = true
planeMesh.receiveShadow = true
planeMesh.material.roughness = .9
planeMesh.material.metalness = .15
planeMesh.material.map = textureLoader('./assets/sea/diffuse.jpg')
planeMesh.material.bumpMap = textureLoader('./assets/sea/bump.jpg')
planeMesh.material.bumpScale = 0.1
planeMesh.material.normalMap = textureLoader('./assets/sea/normal.jpg')
planeMesh.material.normalScale.set(.05,.05)
...
const skyMesh = getParticles(50, 120)
scene.add(skyMesh)
...
function setLight(lightClass) {
  ...
  const lightMaterial = new THREE.MeshBasicMaterial({ 
    color: 0xf5f195,
    map: textureLoader('./assets/sea/moon_1024.jpg'),
   })
  const lightMesh = new THREE.Mesh(lightGeometry, lightMaterial)
  light.add(lightMesh)
  // light.position.set(-3, 2, 5)
  light.position.set(0, 6.5, -15.5)
...
function setGui() {
  ...
  if(planeMesh.material.hasOwnProperty('roughness')){
